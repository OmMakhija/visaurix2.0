...
from feature_extraction import extract_features  # Assuming you have a feature extraction function
...
def train_gmm(features, ubm_model_path, n_components=32):
...
if __name__ == "__main__":
    # Directory containing WAV files for GMM training
    feature_directory = "Data/Ananya"
    ...
    # Train GMM using UBM as baseline
    ubm_model_path = 'model/ubm_model.pkl'  # Path to your UBM model
    
    logging.info("Starting GMM training...")
    
    gmm_model = train_gmm(all_features, ubm_model_path)

    # Save the trained GMM model
    model_path = 'model/Ananya.pkl'
